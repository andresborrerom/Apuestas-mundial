(function(){
  /* CSC SEMIS G3 v3. Llena EMAIL + CUPO (numero) + marcadores. NO envía. */
  ...
  /* 4) RESUMEN */
  if(ok===0){console.log("%c🛑 ESTE FORM NO PARECE SER DE SEMIS (no encontré Francia-España ni Inglaterra-Argentina como partidos). NO ENVÍES NADA. Recarga la página.","font-size:16px;font-weight:bold;color:white;background:red;padding:4px 10px");return;}
